...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      <img class="image" style="width: 260px;" src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="">
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php  
         $select_products = "SELECT * FROM `products` WHERE category = 'Horror'" or die('query failed');
         $res = mysqli_query($conn,$select_products);
         if(mysqli_num_rows($res) > 0){
            while($fetch_products = mysqli_fetch_assoc($res)){
      ?>
